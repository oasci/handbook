...
Code contained in this Handbook is released under the [MIT License](https://spdx.org/licenses/MIT.html) as specified in [`LICENSE.md`](https://gitlab.com/oasci/handbook/-/blob/main/LICENSE.md).
